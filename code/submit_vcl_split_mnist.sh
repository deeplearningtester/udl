...
#SBATCH --output=/scratch/shared/beegfs/user/experiments/vcl/split-mnist/%A_%a.out
#SBATCH --error=/scratch/shared/beegfs/user/experiments/vcl/split-mnist/%A_%a.err
#SBATCH --time=04:00:00
#SBATCH --partition=low-prio-gpu
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=4
#SBATCH --mem=16G
#SBATCH --array=0-9  # Doubled since we run both balanced and imbalanced for coreset methods

# Create logs directory if it doesn't exist
mkdir -p "/scratch/shared/beegfs/user/experiments/vcl/split-mnist"
...
declare -a METHODS=("vcl" "vcl+random_coreset" "vcl+k_center_coreset" "random_coreset" "k_center_coreset")
declare -a CORESET_SIZES=(0 40 40 40 40)
